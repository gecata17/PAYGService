...
import com.example.paygservice.dtos.BalanceDTO;
import com.example.paygservice.dtos.DepositRequest;
import com.example.paygservice.dtos.WithdrawRequest;
...
//
//        // Update balance
//        BigDecimal balance = balanceRepository.findByUserId(userId)
